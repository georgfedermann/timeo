...
/**
 * On (successful) authentication a TimeoWebfrontendUser instance is created and filled
 ...
 * to relevant parts of the system. The instance is kept in the session to provide access
 * to personal information like name and email address within the UI and the respective
 * use cases.
 * Created by georg on 01/05/2017.
 */
public class TimeoWebfrontendUser implements UserDetails {
    ...
    private List<TimeoWebfrontendUserRole> userRoles = new ArrayList<>();
    ...
    public void setGrantedAuthorities(List<String> grantedAuthorities) {
        ...
        for (String authority : grantedAuthorities) {
            userRoles.add(new TimeoWebfrontendUserRole(authority));
        }
    }

    public List<TimeoWebfrontendUserRole> getUserRoles() {
        return userRoles;
    }

    public void setUserRoles(List<TimeoWebfrontendUserRole> userRoles) {
