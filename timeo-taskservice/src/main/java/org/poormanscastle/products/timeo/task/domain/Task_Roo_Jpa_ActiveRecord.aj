...
privileged aspect Task_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Task.fieldNames4OrderClauseFilter = java.util.Arrays.asList("id", "name", "description", "comment", "effortEstimation", "effortMeasured", "entryDate", "dueDate", "startDate", "doneDate", "goal", "status", "priority", "project", "projectTeamMember");
