...
privileged aspect Organisation_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Organisation.fieldNames4OrderClauseFilter = java.util.Arrays.asList("id", "name");
    ...
    public static Organisation Organisation.findOrganisation(String id) {
