...
public class ResourceServiceBean implements ResourceService, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        if (StringUtils.isBlank(wsHostName)) {
            String errMsg = StringUtils.join("WebService hostname is not set for resource service. This is the name of the host on which the resource services are hosted. Please configure it in the file timeo.properties.");
            logger.error(errMsg);
