...
import org.poormanscastle.products.timeo.task.web.TaskController;
...
privileged aspect TaskController_Roo_Controller {
    ...
    void TaskController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("task_entrydate_date_format", "yyyy-MM-dd");
        uiModel.addAttribute("task_duedate_date_format", "yyyy-MM-dd");
        uiModel.addAttribute("task_startdate_date_format", "yyyy-MM-dd");
        uiModel.addAttribute("task_donedate_date_format", "yyyy-MM-dd");
    }
