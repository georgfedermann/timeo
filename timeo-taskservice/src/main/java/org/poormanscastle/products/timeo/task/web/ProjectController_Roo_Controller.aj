...
import org.poormanscastle.products.timeo.task.web.ProjectController;
...
privileged aspect ProjectController_Roo_Controller {
    ...
    public String ProjectController.createForm(Model uiModel) {
        ...
        if (ProjectStatus.countProjectStatuses() == 0) {
            dependencies.add(new String[] { "projectStatus", "projectstatuses" });
        }
    ...
    public String ProjectController.updateForm(@PathVariable("id") String id, Model uiModel) {
        populateEditForm(uiModel, Project.findProject(id));
        return "projects/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ProjectController.delete(@PathVariable("id") String id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void ProjectController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("project_entrydate_date_format", "yyyy-MM-dd");
        uiModel.addAttribute("project_duedate_date_format", "yyyy-MM-dd");
        uiModel.addAttribute("project_startdate_date_format", "yyyy-MM-dd");
        uiModel.addAttribute("project_donedate_date_format", "yyyy-MM-dd");
    }
