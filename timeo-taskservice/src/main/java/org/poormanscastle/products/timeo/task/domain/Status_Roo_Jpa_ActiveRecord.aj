...
privileged aspect Status_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Status.fieldNames4OrderClauseFilter = java.util.Arrays.asList("id", "name", "description");
    ...
    public static Status Status.findStatus(String id) {
